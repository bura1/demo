...
public class WatchListControllerReactiveTest {
    ...
    void returnsEmptyWatchListForAccount() {
        final Single<WatchList> result = client.retrieveWatchList(
                getAuthorizationHeader()).singleOrError();
    ...
    void canUpdateWatchListForAccount() {
        ...
        final HttpResponse<Object> added = client.updateWatchList(
                getAuthorizationHeader(), watchList);
    ...
    void canDeleteWatchListForAccount() {
        ...
        final HttpResponse<Object> deleted = client.deleteWatchList(
